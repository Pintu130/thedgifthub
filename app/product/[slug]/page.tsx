    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 px-4 md:px-8 py-6 md:py-8 max-w-6xl mx-auto w-full">
        <div className="md:flex gap-8 h-full">
          {/* LEFT: Gallery - Sticky container */}
          <div className="md:w-1/2 md:sticky md:top-24 md:h-[calc(100vh-6rem)] md:overflow-y-auto md:pr-4 md:scrollbar-hide">
          ...
          <div className="md:w-1/2 space-y-4 md:pb-8">
            {/* Content sections */}
            <div>
              ...
              <h1 className="text-2xl md:text-3xl font-semibold text-pretty mt-2">{product.name}</h1>
              ...
              <section className="rounded-md border bg-card p-3 space-y-2 my-4">
      ...
      <div className="fixed bottom-14 inset-x-0 z-40 md:hidden border-t bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80">
        <div className="mx-auto max-w-6xl px-4 py-3 flex items-center gap-3">
          ...
          <button
            className="h-12 flex-1 rounded-md bg-orange-500 text-white font-medium shadow hover:bg-orange-600 inline-flex items-center justify-center gap-2"
            onClick={buyNow}
          >
